...
| **Sheet asociado** | El contenedor del script `1TTJ2VjN…`, renombrado el 20-jun-2026 a **`Datos Plataforma Adultos ASC - PROD`** (antes tenía el nombre confuso `adultos-backup-2026-05-17`). Es el Sheet VIVO de prod. _(Pendiente: anotar su ID/URL.)_ |
